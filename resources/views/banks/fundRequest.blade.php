...
<div class="container mx-auto mt-5 px-4">
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div class="p-4">
            <form class="flex flex-wrap gap-2 mb-4" action="{{ route('remittances.add.fund.his') }}" method="GET">
                    ...
                    <tbody>
                        ...
                        <div id="acceptModal{{ $request->id }}" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                            <div class="bg-white p-6 rounded-lg shadow-lg w-96">
                                ...
                                <div class="mt-4 flex justify-end space-x-2">
                                    ...
                                    <form action="{{ route('admin.fund.approve', $request->id) }}" method="POST">
                                        @csrf
                        ...
                        <div id="rejectModal{{ $request->id }}" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                            <div class="bg-white p-6 rounded-lg shadow-lg w-96">
                                ...
                                <form action="{{ route('admin.fund.reject', $request->id) }}" method="POST">
                                    @csrf
    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-4xl mx-4">
        ...
        <div class="flex justify-between items-center border-b p-4">
            <h5 class="text-lg font-semibold">
                Proof Images for Transaction {{ $request->id }}
            </h5>
        ...
        <!-- Body -->
        <div style="max-height:80vh; overflow-y:auto; padding:20px; text-align:center;">
            ...
            @else
                <p style="color:#888;">No proof image available</p>
            @endif
