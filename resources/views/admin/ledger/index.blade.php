...
<div class="mx-auto w-full max-w-[1200px] px-4 text-[13px]">
    ...
    <form method="GET" class="bg-white p-6 rounded-2xl shadow-md border border-gray-100 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
                <label class="text-sm text-gray-600">Merchant ID</label>
                <input type="text" name="mer_id"
                       value="{{ request('mer_id') }}"
            ...
            <table class="min-w-full text-sm">
                <thead class="bg-gray-900 text-white">
                    <tr>
                        ...
                        <th class="p-3 text-left">TDS/GST</th>
              ...
              <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="p-3 ">
                        <div class="font-medium font-semibold text-blue-600">
                            {{ $row->remId ?? '-' }}
                        </div>
