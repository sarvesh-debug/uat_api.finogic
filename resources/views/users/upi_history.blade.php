    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
        ...
        <div>
            ...
            <p class="text-gray-500 text-sm">
                Monitor and manage UPI payout transactions
            </p>
        </div>

        <div class="flex gap-2">
            <a href="{{ route('upi.export.csv', request()->query()) }}"
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white border rounded-lg p-4 shadow-sm">
            ...
            <h3 class="text-lg font-semibold text-yellow-600 mt-1">
                {{ $upi->where('status','Initiated')->count() }}
            </h3>
        </div>
        ...
        <table class="min-w-full text-sm">
            <thead class="bg-gray-100 text-gray-600 uppercase text-[11px]">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left whitespace-nowrap">Payment/Client Ref ID</th>
