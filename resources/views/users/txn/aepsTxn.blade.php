...
<div class="mx-auto w-full max-w-[1200px] px-4 text-[13px]">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
        ...
        <div>
            ...
            <p class="text-gray-500 text-sm">
                Monitor and manage aeps transactions efficiently
            </p>
        </div>

        <div class="flex gap-2">
            <a href="{{ route('track.dmt.export.csv', request()->query()) }}"
    ...
    <div class="bg-white shadow-sm border rounded-lg p-5 mb-5">
        ...
        <form method="GET" action="{{ route('track.aeps.rem') }}"
        ...
        <table class="min-w-full text-sm">
            <thead class="bg-gray-100 text-gray-600 uppercase text-[11px]">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left whitespace-nowrap">OUTLET</th>
                ...
                <tr class="border-t hover:bg-gray-50 transition">
                   ...
                   <td class="px-4 py-3 text-gray-600 whitespace-nowrap">
                    ...
                    <form id="statusForm-{{ $t->id }}"
                        ...
                        class="hidden">
                        @csrf
                        <input type="hidden" name="payment_id" value="{{ $t->external_ref }}">
                        <input type="hidden" name="remId" value="{{ $t->merchant_id }}">
                    </form>
    ...
    <div class="bg-white w-full max-w-2xl rounded-xl shadow-2xl border border-gray-200 relative overflow-hidden">
        ...
        <div class="p-6 space-y-6 text-sm">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div class="bg-gray-50 border rounded-lg p-3">
                    <p class="text-xs text-gray-500 uppercase">Commission</p>
...
function openTxnModal(txn) {
    ...
    document.getElementById('m_payment_id').innerText = txn.external_ref;
    document.getElementById('m_amount').innerText = '₹ ' + txn.transaction_amount;
    document.getElementById('m_charge').innerText = '₹ ' + txn.commission;
    document.getElementById('m_gst').innerText = '₹ ' + txn.tds;
    document.getElementById('m_closing').innerText = '₹ ' + txn.closing_balance;
    document.getElementById('m_beneficiary').innerText = txn.account_last_four;
    document.getElementById('m_bank').innerText = txn.bank_name + ' | ' + txn.bank_name;
    document.getElementById('m_utr').innerText = txn.external_ref ?? '--';
