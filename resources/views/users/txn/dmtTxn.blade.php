...
<div class="mx-auto w-full max-w-[1200px] px-4 text-[13px]">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
        ...
        <div>
            <h2 class="text-xl font-semibold text-gray-800">
               Domestic Money Transfer Transaction Management
            </h2>
            <p class="text-gray-500 text-sm">
                Monitor and manage dmt transactions efficiently
            </p>
        </div>
    ...
    <div class="bg-white shadow-sm border rounded-lg p-5 mb-5">
        ...
        <form method="GET" action="{{ route('track.dmt.rem') }}"
                ...
                <tr class="border-t hover:bg-gray-50 transition">
                   ...
                   <td class="px-4 py-3 text-gray-600 whitespace-nowrap">
                    ...
                    <form id="statusForm-{{ $t->id }}"
                        ...
                        class="hidden">
                        @csrf
                        <input type="hidden" name="payment_id" value="{{ $t->externalRef }}">
...
function openTxnModal(txn) {
    ...
    document.getElementById('m_payment_id').innerText = txn.externalRef;
    document.getElementById('m_amount').innerText = '₹ ' + txn.amount;
    document.getElementById('m_charge').innerText = '₹ ' + txn.charges;
    document.getElementById('m_gst').innerText = '₹ ' + txn.tds;
    document.getElementById('m_closing').innerText = '₹ ' + txn.closing_balance;
    document.getElementById('m_beneficiary').innerText = txn.beneficiaryName;
    document.getElementById('m_bank').innerText = txn.accountNumber + ' | ' + txn.ifsc;
    document.getElementById('m_utr').innerText = txn.externalRef ?? '--';
